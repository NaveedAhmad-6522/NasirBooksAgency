...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'fb52291e-05b9-11f0-9b44-72ea4185d9af:1-2446';
...
CREATE TABLE `books` (
  ...
  UNIQUE KEY `unique_book` (`title`,`publisher`,`edition`),
  UNIQUE KEY `uq_books_idempotency_key` (`idempotency_key`),
...
-- Dump completed on 2026-08-29 13:16:27
