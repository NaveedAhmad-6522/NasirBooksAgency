...
function Invoice({
  ...
  items.forEach((i) => {
    const price = Number(
      i.current_price || i.printed_price || i.price || 0
    );
  ...
  const previousBalance = Number(
    mode === "pos"
      ? previous_balance
      : sale?.previous_balance || data?.previous_balance || 0
  );

  console.log("INVOICE CUSTOMER DEBUG:", {
    data,
    sale,
    customerData,
    customer,
            ...
            <table className="w-full text-[10px] border-collapse mt-1 leading-tight">
              ...
              <tbody>
                {items.map((i, idx) => {
                  ...
                  const publisher =
                    i.publisher || meta.publisher;

                  const edition =
                    i.edition || meta.edition;
              ...
              <tbody>
                ...
                {!isWalkIn && (
                  <tr className="border-t">
                    ...
                    >
                      Rs{" "}
                      {currentCustomerBalance.toLocaleString()}
                    </td>
                  </tr>
                )}
